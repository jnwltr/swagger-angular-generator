...
import {ArrayParams, StructuresService} from '../../demo/generated/controllers/Structures';
import {ArrayStructure} from '../../demo/generated/model';
import {ArrayFormService} from '../../demo/generated/store/structures/array/array.service';
...
describe(`Array form`, () => {
  ...
  it(`should add, remove and modify items properly`, () => {
    ...
    expect(service.form.value !== formDataMockModified).withContext('Form object does not differ from mock object')
      .toBeTruthy();
  ...
  it(`should clear items properly`, () => {
    ...
    expect(service.form.value.arraySection).withContext('Form value array is empty').toEqual(emptyDataMock, );
  });
