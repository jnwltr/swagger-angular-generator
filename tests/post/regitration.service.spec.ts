...
import {RegistrationParams, RegistrationService} from '../../demo/generated/controllers/Registration';
...
describe(`LoginService`, () => {
  ...
  it(`should check request parameters are correct`, () => {
    ...
    delete (bodyParams as Partial<RegistrationParams>).registrationType;
